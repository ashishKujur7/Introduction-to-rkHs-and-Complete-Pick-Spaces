...
\usetheme[block=transparent,numbering=none,progressbar=frametitle]{metropolis}
\usecolortheme{dove}
\usepackage{mathspec}
...
\pause
\begin{theorem}[\citeauthor{zbMATH03056506}\footfullcite{zbMATH03056506}]
...
\begin{frame}{The Pick Nevanlinna Problem in the language of rkHs}
    \citeauthor{1cb1f5bb-aa4a-31e2-ba77-0159c6d327f4} \footfullcite{1cb1f5bb-aa4a-31e2-ba77-0159c6d327f4} realised that the Pick Nevanlinna Problem can be recasted for rkHs. In the following theorem, let $\calH \textcolor{red}{= H^{2} \left( \D \right)}$.
\begin{theorem}
...
\begin{frame}{McCullough-Quiggin Theorem}
   \citeauthor{zbMATH00222166} \footfullcite{zbMATH00222166}: for a rkHs with (irreducible) kernel $K$ with the Complete Pick Property, it is necessary that for each $\lambda_{1}, \lambda_{2}, \ldots, \lambda_{n+1}\in \Omega$, the matrix
\begin{equation*}
...
\citeauthor{MR1284929}\footfullcite{MR1284929} showed that it is necessary. (The current formulation is due to \citeauthor{MR1774853} \footfullcite{MR1774853}).
\end{frame}
...
\pause
\begin{example}[Hardy Space has the Complete Pick Property]
...
\pause
\begin{question}
\citeauthor{MR2187439} \footfullcite{MR2187439} showed there is a class of rkHs which are Pick but not Complete Pick but none of them were analytic function spaces. Are there any analytic rkHs on $\D$ which are Pick but not Complete Pick?
\end{question}
\end{frame}
